...
OUTPUT_FILE = "IIT-M_Labs_Equipment_Browser.html"
...
<title>IIT Madras — Labs & Equipment Browser</title>
<style>
  :root {
    --navy: #0A2747;
    --navy-mid: #0D3461;
 ...
 #table-view { display: none; }
  ...
  /* ════════════════════════════════════════════════════════════════════════
     ...
     ════════════════════════════════════════════════════════════════════════ */
  #ai-fab { position: fixed; right: 24px; bottom: 24px; width: 56px; height: 56px; border-radius: 50%; background: linear-gradient(135deg, var(--gold) 0%, var(--gold-light) 100%); border: none; box-shadow: var(--shadow-lg); cursor: pointer; display: flex; align-items: center; justify-content: center; color: var(--navy); z-index: 200; transition: transform 0.15s; }
  #ai-fab:hover { transform: scale(1.06); }
  #ai-fab svg { width: 24px; height: 24px; }
  #ai-panel { position: fixed; right: 24px; bottom: 92px; width: 380px; max-width: calc(100vw - 32px); height: 540px; max-height: calc(100vh - 130px); background: var(--cream); border-radius: var(--radius); box-shadow: var(--shadow-lg); display: none; flex-direction: column; overflow: hidden; z-index: 200; border: 1px solid var(--border); }
  ...
  .ai-disclaimer { font-size: 10px; color: var(--text-muted); padding: 0 12px 10px; text-align: center; flex-shrink: 0; }
  @media (max-width: 700px) { #ai-panel { right: 12px; left: 12px; width: auto; bottom: 80px; height: calc(100vh - 110px); } #ai-fab { right: 16px; bottom: 16px; } }
</style>
</head>
<body>
<header>
  <div class="header-top">
    <div class="logo-block">
      ...
      <div class="logo-text">
        <h1>IIT Madras — Labs &amp; Equipment</h1>
...
<div id="ai-panel">
  <div class="ai-header">
    <div class="ai-header-text">
      <div class="ai-title">Equipment Assistant</div>
  ...
  <div class="ai-disclaimer">AI-generated suggestions — please confirm availability with the listed contact.</div>
</div>
...
function aiOpen(){
  ...
  if(!aiHistory.length){
    aiAppendBot("Hi! Tell me what you're trying to build, test, or measure, and I'll point you to relevant labs and equipment across IIT Madras.");
  }
  document.getElementById('ai-input').focus();
}
function aiClose(){ document.getElementById('ai-panel').classList.remove('open'); }
